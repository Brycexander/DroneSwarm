...
class Status(genpy.Message):
  _md5sum = "a8713aed3675b705b48283504ffb811c"
...
"""
  ...
  __slots__ = ['header','vehicle_name','vehicle_type','battery_voltage','rc_command_mode','command_interface_enabled','flight_time','system_uptime','cpu_load','motor_status','gps_status','gps_num_satellites']
  _slot_types = ['std_msgs/Header','string','string','float32','string','bool','float32','float32','float32','string','string','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,vehicle_name,vehicle_type,battery_voltage,rc_command_mode,command_interface_enabled,flight_time,system_uptime,cpu_load,motor_status,gps_status,gps_num_satellites
