...
if("TRUE" STREQUAL "TRUE")
  set(minkindr_conversions_SOURCE_PREFIX /home/qwerty/catkin_ws/src/nbvplanner/minkindr_ros/minkindr_conversions)
  set(minkindr_conversions_DEVEL_PREFIX /home/qwerty/catkin_ws/devel)
  ...
  set(minkindr_conversions_INSTALL_PREFIX /home/qwerty/catkin_ws/install)
...
if(NOT "/home/qwerty/catkin_ws/src/nbvplanner/minkindr_ros/minkindr_conversions/include " STREQUAL " ")
  set(minkindr_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/qwerty/catkin_ws/src/nbvplanner/minkindr_ros/minkindr_conversions/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'minkindr_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/qwerty/catkin_ws/src/nbvplanner/minkindr_ros/minkindr_conversions/${idir}'.  ${_report}")
    endif()
    _list_append_unique(minkindr_conversions_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "minkindr_conversions")
...
set(depends "eigen_conversions;geometry_msgs;glog_catkin;minkindr;tf;tf_conversions")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(minkindr_conversions_EXPORTED_TARGETS ${${minkindr_conversions_dep}_EXPORTED_TARGETS})
endforeach()
