...
if(nbvplanner_CONFIG_INCLUDED)
  return()
endif()
set(nbvplanner_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(nbvplanner_SOURCE_PREFIX /home/qwerty/catkin_ws/src/nbvplanner/nbvplanner)
  set(nbvplanner_DEVEL_PREFIX /home/qwerty/catkin_ws/devel)
  set(nbvplanner_INSTALL_PREFIX "")
  set(nbvplanner_PREFIX ${nbvplanner_DEVEL_PREFIX})
else()
  set(nbvplanner_SOURCE_PREFIX "")
  set(nbvplanner_DEVEL_PREFIX "")
  set(nbvplanner_INSTALL_PREFIX /home/qwerty/catkin_ws/install)
  set(nbvplanner_PREFIX ${nbvplanner_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'nbvplanner' is deprecated")
...
set(nbvplanner_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/qwerty/catkin_ws/devel/include;/home/qwerty/catkin_ws/src/nbvplanner/nbvplanner/include;/usr/include/eigen3;/usr/include;/home/qwerty/catkin_ws/devel/include/eigen3/;/home/qwerty/catkin_ws/src/nbvplanner/volumetric_mapping/octomap_world/include;/home/qwerty/catkin_ws/src/nbvplanner/minkindr_ros/minkindr_conversions/include;/home/qwerty/catkin_ws/src/nbvplanner/minkindr/minkindr/include;/home/qwerty/catkin_ws/src/nbvplanner/volumetric_mapping/volumetric_map_base/include;/home/qwerty/catkin_ws/src/nbvplanner/kdtree/include;/home/qwerty/catkin_ws/src/nbvplanner/multiagent_collision_check/include;/opt/ros/noetic/include;/opt/ros/noetic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/share/orocos_kdl/cmake/../../../include;/usr/include/pcl-1.10;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/opencv4 " STREQUAL " ")
  set(nbvplanner_INCLUDE_DIRS "")
  set(_include_dirs "/home/qwerty/catkin_ws/devel/include;/home/qwerty/catkin_ws/src/nbvplanner/nbvplanner/include;/usr/include/eigen3;/usr/include;/home/qwerty/catkin_ws/devel/include/eigen3/;/home/qwerty/catkin_ws/src/nbvplanner/volumetric_mapping/octomap_world/include;/home/qwerty/catkin_ws/src/nbvplanner/minkindr_ros/minkindr_conversions/include;/home/qwerty/catkin_ws/src/nbvplanner/minkindr/minkindr/include;/home/qwerty/catkin_ws/src/nbvplanner/volumetric_mapping/volumetric_map_base/include;/home/qwerty/catkin_ws/src/nbvplanner/kdtree/include;/home/qwerty/catkin_ws/src/nbvplanner/multiagent_collision_check/include;/opt/ros/noetic/include;/opt/ros/noetic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/share/orocos_kdl/cmake/../../../include;/usr/include/pcl-1.10;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND nbvplanner_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/qwerty/catkin_ws/devel/lib;/home/qwerty/catkin_ws/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(nbvplanner_LIBRARY_DIRS ${lib_path})
      list(APPEND nbvplanner_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'nbvplanner'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND nbvplanner_LIBRARIES ${lib})
    endif()
  endif()
...
set(nbvplanner_EXPORTED_TARGETS "nbvplanner_generate_messages_cpp;nbvplanner_generate_messages_eus;nbvplanner_generate_messages_lisp;nbvplanner_generate_messages_nodejs;nbvplanner_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${nbvplanner_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "message_runtime;roscpp;geometry_msgs;visualization_msgs;octomap_world;tf;kdtree")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 nbvplanner_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${nbvplanner_dep}_FOUND)
      find_package(${nbvplanner_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${nbvplanner_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(nbvplanner_INCLUDE_DIRS ${${nbvplanner_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(nbvplanner_LIBRARIES ${nbvplanner_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${nbvplanner_dep}_LIBRARIES})
  _list_append_deduplicate(nbvplanner_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(nbvplanner_LIBRARIES ${nbvplanner_LIBRARIES})

  _list_append_unique(nbvplanner_LIBRARY_DIRS ${${nbvplanner_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(nbvplanner_EXPORTED_TARGETS ${${nbvplanner_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "nbvplanner-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${nbvplanner_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
