...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Octomap-request>)))
  ...
  (cl:format cl:nil "# The center point of the axis-aligned bounding box in the global frame~%geometry_msgs/Point bounding_box_origin~%# The 3 side lenghts of the axis-aligned bounding box~%geometry_msgs/Point bounding_box_lengths~%# The leaf size or resolution of the octomap~%float64 leaf_size~%# The filename under which the octomap should be stored (only stored if set)~%string filename~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Octomap-request)))
  "Returns full string definition for message of type 'Octomap-request"
  (cl:format cl:nil "# The center point of the axis-aligned bounding box in the global frame~%geometry_msgs/Point bounding_box_origin~%# The 3 side lenghts of the axis-aligned bounding box~%geometry_msgs/Point bounding_box_lengths~%# The leaf size or resolution of the octomap~%float64 leaf_size~%# The filename under which the octomap should be stored (only stored if set)~%string filename~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
