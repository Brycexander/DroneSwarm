...
get_filename_component(_filename "/home/qwerty/catkin_ws/src/nbvplanner/nbvplanner/srv/nbvp_srv.srv" NAME_WE)
add_custom_target(_nbvplanner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "nbvplanner" "/home/qwerty/catkin_ws/src/nbvplanner/nbvplanner/srv/nbvp_srv.srv" "geometry_msgs/Pose:geometry_msgs/Point:geometry_msgs/Quaternion:std_msgs/Header"
)
...
_generate_srv_cpp(nbvplanner
  "/home/qwerty/catkin_ws/src/nbvplanner/nbvplanner/srv/nbvp_srv.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/nbvplanner)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/nbvplanner\")")
  # install generated code
  install(
